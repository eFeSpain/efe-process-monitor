...
- Para acceder desde otra máquina, lo más simple es un **túnel SSH** (cifrado, nada
  expuesto): `ssh -L 5000:localhost:5000 usuario@host`, y abrir
  `http://localhost:5000`. Una VPN como Tailscale también vale.
