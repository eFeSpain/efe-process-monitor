...
- To reach it from another machine, the simplest option is an **SSH tunnel**
  (encrypted, nothing exposed): `ssh -L 5000:localhost:5000 user@host`, then open
  `http://localhost:5000`. A VPN like Tailscale works too.
